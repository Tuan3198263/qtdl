...
class ThuePhongWindow(QMainWindow):
       ...
       # Phần nhập thông tin
        ...
        for label_text in labels:
            ...
            if label_text in ["Ngày vào", "Ngày ra"]:
                ...
                date_edit.setCalendarPopup(True)  # Hiển thị lịch khi click vào
    ...
    def thue_phong(self):
        ...
        ngay_vao = self.ngay_vao_edit.date().toString("yyyy-MM-dd")
        ngay_ra = self.ngay_ra_edit.date().toString("yyyy-MM-dd")
